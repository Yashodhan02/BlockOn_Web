...
@Component({
  selector: 'app-co-branded-issue-blocks-to-store',
  templateUrl: './co-branded-issue-blocks-to-store.component.html',
  styleUrls: ['./co-branded-issue-blocks-to-store.component.scss']
})
export class CoBrandedIssueBlocksToStoreComponent {
...
submitAndDistributeToOwnStore() {
  ...
  this.apiService.issueCoBrandedBlocksToStore(requestData).subscribe(
    (response) => {
      console.log(response);
